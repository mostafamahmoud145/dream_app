...
import '../config/network_manager.dart';
...
class CallKitService {
  ...
  static Future<void> displayIncomingCall( Map <String, dynamic> data) async {
    ...
    var defaultAvatar=NetworkManager.appLogo;
    ...
    final params = CallKitParams(
      ...
      handle: langCode!=null&&langCode=='ar'?"مكالمة واردة":"Incoming Call",
      type: 0,
      duration: 30000,
      ...
      missedCallNotification: NotificationParams(
        ...
        subtitle: langCode!=null&&langCode=='ar'?" مكالمة فائتة": 'Missed Calls',
